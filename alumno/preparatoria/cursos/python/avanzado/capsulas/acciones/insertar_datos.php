...
$insertarEstadisticas = mysqli_query($conexion, "UPDATE estadisticas_preparatoria SET trofeos = '$totalTrofeos', progreso = '$totalProgreso', puntos = '$totalPuntos', audivisual = '$totalAudivisual', practico = '$totalPractico', teorico = '$totalTeorico' WHERE id_alumno = $id_user");
