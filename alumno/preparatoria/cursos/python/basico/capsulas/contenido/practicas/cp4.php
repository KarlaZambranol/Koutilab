                        ...
                        <tr>
                            ...
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../vid/CV4.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
        ...
        function miFunc() {
            ...
            if (images == 3) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd13.php?validar=' + 'correcto' + '&permiso=' + 13 + '&id_curso=' + 4 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd13.php?validar=' + 'incorrecto' + '&permiso=' + 13 + '&id_curso=' + 4 + '&practico=' + 10;
                    }
                });
            }
        }
