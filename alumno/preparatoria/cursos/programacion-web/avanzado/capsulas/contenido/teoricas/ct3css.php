        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/ct3css/ct3.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/ct3css/ct33.gif');"></li>
                        <li style="background-image: url('../../img/ct3css/ct333.gif');"></li>
                        <li style="background-image: url('../../img/ct3css/ct3333.gif');"></li>
                        <li style="background-image: url('../../img/ct3css/ct33333.gif');"></li>
                        <li style="background-image: url('../../img/ct3css/ct333333.gif');"></li>
                        <li>
