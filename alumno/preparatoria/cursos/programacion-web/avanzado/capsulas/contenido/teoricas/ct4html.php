        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/ct4html/ct4.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/ct4html/ct44.gif');"></li>
                        <li style="background-image: url('../../img/ct4html/ct444.gif');"></li>
                        <li style="background-image: url('../../img/ct4html/ct4444.gif');"></li>
                        <li style="background-image: url('../../img/ct4html/ct44444.gif');"></li>
                        <li style="background-image: url('../../img/ct4html/ct444444.gif');"></li>
                        <li>
