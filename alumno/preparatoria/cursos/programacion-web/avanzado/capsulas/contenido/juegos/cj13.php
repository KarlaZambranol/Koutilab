...
<body onload="iniciarTiempo();">
    ...
    <div class="contenido">
        ...
        <div class="imagenes">
            <div class="caja-img">
                <img src="../../img/img_juegos/img/box1.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/box2.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/input1.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/box3.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/input2.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/box4.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/input3.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/box5.png" alt="" draggable="true" ondragstart="drag(event)" id="html" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/input4.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
            <div class="caja-img">
                <img src="../../img/img_juegos/img/input5.png" alt="" draggable="true" ondragstart="drag(event)" id="css" class="imagen1">
            </div>
        </div>

        <!-- Caja donde se encuentran los espacios para colocar las imagenes de HTML -->
        <div class="caja-html"  style="font-size: 67%;">
            <!-- Etiquetas HTML -->
            <div class="ht1">
                <div class="html-b-t">PROPIEDADES<br>DE CAJA</div>
            </div>
            <div class="ht2">
                <div class="html-b-t">PROPIEDADES<br>DE CAJA</div>
            </div>
    ...
    <script>
        ...
        function iniciarTiempo() {
            ...
            if (segundos == 0) {
                ...
                var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 35 + "&id_curso=" + 3; //cancatenation
                Swal.fire({
                    title: 'Oops...',
        ...
        function verificar() {
            if (arreglo[0] != "" && arreglo[1] != "" && arreglo[2] != "" && arreglo[3] != "" && arreglo[4] != "" && arreglo[5] != "" && arreglo[6] != "" && arreglo[7] != "" && arreglo[8] != "" && arreglo[9] != "") {
                if (arreglo[0] == "html" && arreglo[1] == "html" && arreglo[2] == "html" && arreglo[3] == "html" && arreglo[4] == "html" && arreglo[5] == "css" && arreglo[6] == "css" && arreglo[7] == "css" && arreglo[8] == "css" && arreglo[9] == "css") {
                    ...
                    var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 35 + "&id_curso=" + 3; //cancatenation
