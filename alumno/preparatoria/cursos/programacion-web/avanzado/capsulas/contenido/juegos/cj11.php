...
<body onload="iniciarTiempo();">
	...
	<div class="contenido" style="height: 550px;">
				...
				<tr>
					...
					<td>
						<div class="horizontal" style="margin-top: 30px;">
							1. Es la acción de llevar a un usuario de una página web a otra mediante JavaScript.
							<br><br>
							2. Es el lenguaje de programación que estamos estudiando actualmente.
							<br><br>
							3. Es la función que se usa para hacer esperar al usuario 3 segundos o más antes de llevarlo
							a otro lugar.
						</div>
					</td>
					...
					<td>
						<div class="vertical">
							1. Es una forma de llevar a otra página a un usuario, se puede decir que te redirige a otro lugar
							si le das clic al ______ .
						</div>
					</td>
				</tr>
			</table>
		...
		<div class="linea" style="height: 400px;"></div>

		<!-- Apartado del crucigrama junto con sus casillas -->
		<div class="crucigrama" style="margin: 20px 110px 0 0; scale: 75%;">
			<div class="numero1" style="margin: 170px 0 0 135px;">2.</div>
			<div class="numero2" style="margin: 15px 0 0 32px;">1.</div>
			<div class="numero3-3" style="margin: 275px 0 0 -20px;">3.</div>
			<div class="numero2-2" style="margin: -20px 0 0 333px;">1.</div>
			...
			<table>
				...
				<tr>
					...
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila5C14" style="border-style: none; background-color: rgba(255, 255, 255, 0);"/>
					</td>
				</tr>
				<tr>
					<td>
		...
		<button class="verificar" style="margin-top: 550px;" onClick="verificar()">Comprobar respuestas</button>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 29 + "&id_curso=" + 3; //cancatenation
				Swal.fire({
					title: 'Oops...',
	...
	<script>
		...
		var palabra1_letra8 = document.getElementById("fila1C9");
		var palabra1_letra9 = document.getElementById("fila1C10");
		var palabra1_letra10 = document.getElementById("fila1C11");
		var palabra1_letra11 = document.getElementById("fila1C12");
		var palabra1_letra12 = document.getElementById("fila1C13");
		var palabra1_letra13 = document.getElementById("fila1C14");
		...
		var palabra2_letra10 = document.getElementById("fila6C10");


		//Palabra JAVASCRIPT
		var palabra3_letra1 = document.getElementById("fila4C4");
		var palabra3_letra2 = document.getElementById("fila4C5");
		var palabra3_letra3 = document.getElementById("fila4C6");
		var palabra3_letra4 = document.getElementById("fila4C7");
		var palabra3_letra5 = document.getElementById("fila4C8");
		var palabra3_letra6 = document.getElementById("fila4C9");
		var palabra3_letra7 = document.getElementById("fila4C10");
		var palabra3_letra8 = document.getElementById("fila4C11");
		var palabra3_letra9 = document.getElementById("fila4C12");
		var palabra3_letra10 = document.getElementById("fila4C13");
		...
		function verificar() {
			document.getElementById("mensaje").innerHTML = "";
			palabra1 = palabra1_letra1.value + palabra1_letra2.value + palabra1_letra3.value + palabra1_letra4.value + palabra1_letra5.value + palabra1_letra6.value + palabra1_letra7.value + palabra1_letra8.value + palabra1_letra9.value + palabra1_letra10.value + palabra1_letra11.value + palabra1_letra12.value + palabra1_letra13.value;
			...
			if (palabra1.toLowerCase() == "redireccionar" && palabra2.toLowerCase() == "settimeout" && palabra3.toLowerCase() == "javascript" && palabra4.toLowerCase() == "enlace") {
				var xmlhttp = new XMLHttpRequest();

				var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 29 + "&id_curso=" + 3; //cancatenation
				...
				if (palabra1.toLowerCase() != "redireccionar") {
				...
				if (palabra2.toLowerCase() != "settimeout") {
				...
				if (palabra3.toLowerCase() != "javascript") {
				...
				if (palabra4.toLowerCase() != "enlace") {
				...
				if (palabra2.toLowerCase() == "settimeout") {
					palabra4_letra6.value = "e";
				}

				if (palabra3.toLowerCase() == "javascript") {
					palabra4_letra4.value = "a";
				}
