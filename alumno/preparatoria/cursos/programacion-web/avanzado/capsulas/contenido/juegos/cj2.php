...
<body onload="iniciarTiempo();">
    ...
    <div class="contenido">
        ...
        <div class="caja-html">
            <!-- Etiquetas HTML -->
            <div class="ht1"><div class="html-b-t">PROGRESO</div></div>
            <div class="ht2"><div class="html-b-t">PROGRESO</div></div>
            <div class="ht3"><div class="html-b-t">PROGRESO</div></div>
            <div class="ht4"><div class="html-b-t">PROGRESO</div></div>
            <div class="ht5"><div class="html-b-t">PROGRESO</div></div>
        ...
        <div class="caja-css">
            <!-- Etiquetas CSS -->
            <div class="ht1"><div class="html-b-t">MEDIDOR</div></div>
            <div class="ht2"><div class="html-b-t">MEDIDOR</div></div>
            <div class="ht3"><div class="html-b-t">MEDIDOR</div></div>
            <div class="ht4"><div class="html-b-t">MEDIDOR</div></div>
            <div class="ht5"><div class="html-b-t">MEDIDOR</div></div>
