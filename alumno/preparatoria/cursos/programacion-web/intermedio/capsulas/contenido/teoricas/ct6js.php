        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria6js/CT6.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria6js/CT66.gif');"></li>
                        <li style="background-image: url('../../img/teoria6js/CT666.gif');"></li>
                        <li style="background-image: url('../../img/teoria6js/CT6666.gif');"></li>
