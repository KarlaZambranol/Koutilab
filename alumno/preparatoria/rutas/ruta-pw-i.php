...
$sql_verificar_html1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas c INNER JOIN detalle_capsulas d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_html1' AND d.id_curso = 2");
...
$sql_comprada_html1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago c INNER JOIN detalle_capsulas_pago d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_html1' AND d.id_curso = 2;");
...
$sql_verificar_html2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas c INNER JOIN detalle_capsulas d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_html2' AND d.id_curso = 2");
...
$sql_comprada_html2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago c INNER JOIN detalle_capsulas_pago d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_html2' AND d.id_curso = 2;");
...
$sql_verificar_css1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas c INNER JOIN detalle_capsulas d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_css1' AND d.id_curso = 2");
...
$sql_comprada_css1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago c INNER JOIN detalle_capsulas_pago d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_css1' AND d.id_curso = 2;");
...
$sql_verificar_css2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas c INNER JOIN detalle_capsulas d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_css2' AND d.id_curso = 2");
...
$sql_comprada_css2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago c INNER JOIN detalle_capsulas_pago d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_css2' AND d.id_curso = 2;");
...
$sql_verificar_js1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas c INNER JOIN detalle_capsulas d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_js1' AND d.id_curso = 2");
...
$sql_comprada_js1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago c INNER JOIN detalle_capsulas_pago d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_js1' AND d.id_curso = 2;");
...
$sql_comprada_js2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago c INNER JOIN detalle_capsulas_pago d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_js2' AND d.id_curso = 2;");
    ...
    <div class="body">
        ...
        <div class="container">
            ...
            <div class="ruta">
                ...
                <!-- TEMA 2 -->
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct2html.php"><button class="btn5" id="teoria" <?php echo 'style="' . (($existe_verificar_html1 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_html1 > 0) ? 'opacity: 1;' : 'opacity: 0.5; filter: contrast(50%) sepia(1) hue-rotate(20deg) saturate(500%);') . '"'; ?>></button></a><!--Capsula teorica 2-->
                ...
                <!-- TEMA 6 -->
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct6html.php" <?php echo 'style="' . (($existe_verificar_html2 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_html2 > 0) ? 'opacity: 1;' : 'opacity: 0.5; filter: contrast(50%) sepia(1) hue-rotate(20deg) saturate(500%);') . '"'; ?>><button class="btn17" id="teoria"></button></a><!--Capsula teorica 6-->
                ...
                <!-- TEMA 1 -->
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct1css.php"><button class="btn25" id="teoria" <?php echo 'style="' . (($existe_verificar_css1 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_css1 > 0) ? 'opacity: 1;' : 'opacity: 0.5; filter: contrast(50%) sepia(1) hue-rotate(20deg) saturate(500%);') . '"'; ?>></button></a><!--Capsula teorica 1-->
                ...
                <!-- TEMA 6 -->
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct6css.php"><button class="btn40" id="teoria" <?php echo 'style="' . (($existe_verificar_css2 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_css2 > 0) ? 'opacity: 1;' : 'opacity: 0.5; filter: contrast(50%) sepia(1) hue-rotate(20deg) saturate(500%);') . '"'; ?>></button></a><!--Capsula teorica 6-->
                ...
                <!-- TEMA 7 -->
                <a href="../cursos/programacion-web/intermedio/capsulas/contenido/teoricas/ct7js.php"><button class="btn66" id="teoria" <?php echo 'style="' . (($existe_verificar_js2 > 0 || $id_user == 1) ? 'display: block;' : 'display: none;') . ' ' . (($existe_comprada_js2 > 0) ? 'opacity: 1;' : 'opacity: 0.5; filter: contrast(50%) sepia(1) hue-rotate(20deg) saturate(500%);') . '"'; ?>></button></a><!--Capsula teorica 7-->
