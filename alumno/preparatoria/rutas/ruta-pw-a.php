...
$sql_verificar_html1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_preparatoria c INNER JOIN detalle_capsulas_preparatoria d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_html1' AND d.id_curso = 3");
...
$sql_comprada_html1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_html1' AND d.id_curso = 3;");
...
$sql_verificar_html2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_preparatoria c INNER JOIN detalle_capsulas_preparatoria d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_html2' AND d.id_curso = 3");
...
$sql_comprada_html2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_html2' AND d.id_curso = 3;");
...
$sql_verificar_css1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_preparatoria c INNER JOIN detalle_capsulas_preparatoria d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_css1' AND d.id_curso = 3");
...
$sql_comprada_css1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_css1' AND d.id_curso = 3;");
...
$sql_verificar_css2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_preparatoria c INNER JOIN detalle_capsulas_preparatoria d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_css2' AND d.id_curso = 3");
...
$sql_comprada_css2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_css2' AND d.id_curso = 3;");
...
$sql_verificar_js1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_preparatoria c INNER JOIN detalle_capsulas_preparatoria d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_js1' AND d.id_curso = 3");
...
$sql_comprada_js1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_js1' AND d.id_curso = 3;");
...
$sql_comprada_js2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_js2' AND d.id_curso = 3;");
$existe_comprada_js2 = mysqli_num_rows($sql_comprada_js2);

//Verificar si capsula esta completada para mostrar la opcion de compra de capsula 1 de js
$capsula_verificar_php1 = "capsula54";
$sql_verificar_php1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_preparatoria c INNER JOIN detalle_capsulas_preparatoria d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_verificar_js1' AND d.id_curso = 3");
$existe_verificar_cphp1 = mysqli_num_rows($sql_verificar_php1);

//Verificar si esta comprada la capsula 1 de js
$capsula_comprada_php1 = "capsulapago5";
$sql_comprada_php1 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_js1' AND d.id_curso = 3;");
...
$sql_comprada_php2 = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas_pago_preparatoria c INNER JOIN detalle_capsulas_pago_preparatoria d ON c.id_capsula_pago = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$capsula_comprada_js2' AND d.id_curso = 3;");
