...
<body>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Instrucciones: El alumno tendrá que hacer una página donde describa su serie o película favorita.
                                    Esta puede ser una serie de televisión, de streaming o incluso de Youtube.
                                    Deberán hacer una página que contenga:
                                    1. Título Color Morado, fondo blanco
                                    2. Descripción (de qué se trata) color azul claro, fondo azul obscuro
                                    3. Lista de los personajes en itálicas Cada nombre debe tener un color diferente
                                    4. Imagen de la portada
                                    <br> <br>
                                </p>
                            </td>
                            <td class="ne">
    ...
    <script>
        ...
        `,
                            ...
                            window.location.href = '../../acciones/insertar_pd22.php?validar=' + 'incorrecto' + '&permiso=' + 22 + '&id_curso=' + 4 + '&practico=' + 10;
                        });
                    }
                }
            }
