            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Escribir los números impares desde el 1 hasta donde el usuario te diga. 
                                    Ejemplo: si el usuario ingresa el número 12, el programa va a escribir 1, 3, 5, 7, 9, 11.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/numeros.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
