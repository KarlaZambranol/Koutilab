        ...
        <div class="container">
                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> 
                                Haz un programa para obtener el promedio de un grupo de 10 alumnos. 
                                El programa debe de ser hecho con un while y debe solicitar la calificación de 
                                cada alumno para desplegar el promedio de los 10.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/promedio.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="">
                ...
                <div class="editor-container">
                    <div class="cd" id="editor"># Programación intermedia con Python</div>
                </div>
            </div>
