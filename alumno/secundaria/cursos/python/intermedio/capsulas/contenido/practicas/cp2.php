                ...
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> 
                                Hacer un programa que te de la tabla de multiplicar de un número. Ejemplo: si el usuario ingresa un 3, el programa va a escribir 3, 6, 9, 12, 15, 18, 21, 24, 26, 30.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/tabla.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
