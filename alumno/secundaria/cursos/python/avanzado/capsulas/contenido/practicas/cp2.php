...
$id_user = $_SESSION['id_alumno_secundaria'];
$permiso = "capsula19";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas c INNER JOIN detalle_capsulas d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$permiso' AND d.id_curso = 6");
...
<body>
    ...
    <script>
            ...
            if (!esCorrecto) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'incorrecto' + '&permiso=' + 7 + '&id_curso=' + 6 + '&practico=' + 10;
                    }
                });
            } else {
                Swal.fire({
        ...
        `,
                    ...
                    window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'correcto' + '&permiso=' + 7 + '&id_curso=' + 6 + '&practico=' + 10;
                });
            }
        }
    </script>
