            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> BECA – Un alumno quiere saber si conserva su beca para la universidad.
                                    Para conservar la beca requiere obtener 85 o más de promedio en 6
                                    materias. Crea un programa que ayude al alumno a saber esto.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/beca.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
