            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> PASSWORD – Hacer un programa que revise si la contraseña ingresada por
                                    el usuario es igual a 1234. Si el usuario ingresa la contraseña correcta,
                                    puede pasar.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/password.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
