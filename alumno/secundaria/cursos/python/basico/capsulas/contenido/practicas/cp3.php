...
$id_user = $_SESSION['idUser'];
$permiso = "capsula3";
$sql = mysqli_query($conexion, "SELECT c.*, d.* FROM capsulas c INNER JOIN detalle_capsulas d ON c.id_capsula = d.id_permiso WHERE d.id_usuario = $id_user AND c.nombre = '$permiso'");
...
<body>
    <div class="body">
        <div class="container">
            <a href="../../../../../../rutas/ruta.php"><button style="float: left;" class="btn-b" id="btn-cerrar-modalV"><i class="fas fa-reply"></i></button></a>
            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> DESCUENTO – En una tienda, si un cliente compra más de $120 recibe un 24%
                                    de descuento. Haz un programa que le diga al cliente si obtiene descuento
                                    o no, además si lo obtiene, de cuanto es su descuento y cual es su total a
                                    pagar.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/descuento.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="">
                ...
                <div class="editor-container">
                    <div class="cd" id="editor"># Programación básica con Python</div>
                </div>
            </div>
        ...
        function miFunc() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '../../acciones/insertar_pd4.php';
                }
            });
        }
    </script>
