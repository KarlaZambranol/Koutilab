            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Instrucciones: escribir su nombre en un título < h1>, luego tendrán que escribir
                                        2 subtítulos < h2> que tendrán el nombre de sus animales favoritos, debajo de
                                            cada subtítulo tendrán que escribir en un párrafo < p> por qué les gusta ese animal.
                                                Finalmente tendrán que modificar el color de las letras del titulo h1 a verde, el
                                                fondo de los subtítulos h2 a amarillo y el fondo de los párrafos a gris y el color
                                                de las letras blanco.
                                                <br> <br>
                                                Ejemplos de como debe quedar:<br> <br>
                                                <h1 style="color: green;">Jose Luna Romero</h1>
                                                <h2 style="background-color: yellow;">Gato</h2>
                                                <p style="background-color: gray; color: white;">Su pelaje es muy bonito y suave</p>
                                                <h2 style="background-color: yellow;">Perro</h2>
                                                <p style="background-color: gray; color: white;">Su ladrido es muy bonito</p>
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../vid/CV6.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
    ...
    <script>
        ...
        function miFunc() {
            ...
            `,
                    ...
                    window.location.href = '../../acciones/insertar_pd20.php?validar=' + 'correcto' + '&permiso=' + 20 + '&id_curso=' + 4 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd20.php?validar=' + 'incorrecto' + '&permiso=' + 20 + '&id_curso=' + 4 + '&practico=' + 10;
                    }
                });
            }
        }
