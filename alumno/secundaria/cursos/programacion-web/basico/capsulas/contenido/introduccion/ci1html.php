    ...
    <div class="body">
        <div class="container">
            ...
            <section id="container-slider">
                ...
                <ul id="slider">
                    <li style="background-image: url('../../img/introduccionhtml/CIN1.gif'); z-index:0; opacity: 1;"></li>
                    <li style="background-image: url('../../img/introduccionhtml/CIN11.gif');"></li>
                    <li style="background-image: url('../../img/introduccionhtml/CIN111.gif');"></li>
