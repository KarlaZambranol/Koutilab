    ...
    <div class="body">
        <div class="container">
            ...
            <section id="container-slider">
                ...
                <ul id="slider">
                    <li style="background-image: url('../../img/bienvenidaintermedio/B1.gif'); z-index:0; opacity: 1;"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/B11.gif');"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/B111.gif');"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/B1111.gif');"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/B11111.gif');"></li>
                    <li style="background-image: url('../../img/bienvenidaintermedio/B111111.gif');"></li>
