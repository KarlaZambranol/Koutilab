...
<body onload="iniciarTiempo();">
	...
	<div class="contenido" style="height: 850px;">
				...
				<tr>
					...
					<td>
						<div class="horizontal" style="margin-top: 40px;">
							1. Es lo que presinamos al finalizar el llenado de un formulario para poder enviarlo.
							<br><br>
							2. Es el método que posee un botón para poder enviar información una vez sea haya presionado.
							<br><br>
							3. Se le llama ___________ al conjunto de campos a llenar con información para posteriormente poder enviarla. 
						</div>
					</td>
					<b style="margin-left: 160px;">Verticales:</b>
					<td>
						<div class="vertical">
							1. Se le llama ___________ a lo que ocupamos para llenar un formulario.
							<br><br>
							2. Es la acción con la que nosotros los programadores manipulamos la información que se nos envia mediante el formulario.
							<br><br>
							3. Es donde nosotros podemos almacenar la información que se nos envia mediante un formulario.
						</div>
					</td>
				</tr>
			</table>
		...
		<div class="linea" style="height: 650px;"></div>

		<!-- Apartado del crucigrama junto con sus casillas -->
		<div class="crucigrama" style="scale: 90%; margin: 0 60px 0 0;">
			<div class="numero1" style="margin: 82px 0 0 72px;">1.</div>
			<div class="numero2" style="margin: -20px 0 0 490px;">3.</div>
			<div class="numero3-3" style="margin: 185px 0 0 385px;">2.</div>
			<div class="numero1-1" style="margin: 585px 0 0 -20px;">3.</div>
			<div class="numero2-2" style="margin: 120px 0 0 345px;">2.</div>
			<div class="numero2-2" style="margin: 275px 0 0 -20px;">1.</div>
			...
			<table>
				...
				<tr>
					...
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila5C10" style="background-color: rgb(92, 92, 92);" />
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila8C10" style="background-color: rgb(92, 92, 92);" />
					</td>
					<td>
				...
				<tr>
					...
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila12C11" style="border-style: none; background-color: rgba(255, 255, 255, 0);" />
					</td>
				</tr>
				<tr>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C1" style="border-style: none; background-color: rgba(255, 255, 255, 0);" />
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C2"  />
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C3" style="border-style: none; background-color: rgba(255, 255, 255, 0);" />
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C4" style="border-style: none; background-color: rgba(255, 255, 255, 0);" />
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C5" style="border-style: none; background-color: rgba(255, 255, 255, 0);"/>
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C6" style="border-style: none; background-color: rgba(255, 255, 255, 0);" />
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C7" style="border-style: none; background-color: rgba(255, 255, 255, 0);" />
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C8" style="border-style: none; background-color: rgba(255, 255, 255, 0);"/>
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C9" style="border-style: none; background-color: rgba(255, 255, 255, 0);"/>
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C10" />
					</td>
					<td>
						<input class="casilla" type="text" maxlength="1" id="fila13C11" style="border-style: none; background-color: rgba(255, 255, 255, 0);" />
					</td>
				</tr>
			</table>
		</div>
		...
		<button class="verificar" style="margin-top: 820px;" onClick="verificar()">Comprobar respuestas</button>
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 12 + "&id_curso=" + 3; //cancatenation
				Swal.fire({
					title: 'Oops...',
	...
	<script>
		...
		//Palabra FORMULARIO
		var palabra1_letra1 = document.getElementById("fila12C1");
		var palabra1_letra2 = document.getElementById("fila12C2");
		var palabra1_letra3 = document.getElementById("fila12C3");
		var palabra1_letra4 = document.getElementById("fila12C4");
		var palabra1_letra5 = document.getElementById("fila12C5");
		var palabra1_letra6 = document.getElementById("fila12C6");
		var palabra1_letra7 = document.getElementById("fila12C7");
		var palabra1_letra8 = document.getElementById("fila12C8");
		var palabra1_letra9 = document.getElementById("fila12C9");
		var palabra1_letra10 = document.getElementById("fila12C10");
		...
		var palabra2_letra7 = document.getElementById("fila11C8");
		var palabra2_letra8 = document.getElementById("fila12C8");


		//Palabra INFORMACION
		var palabra3_letra1 = document.getElementById("fila3C2");
		var palabra3_letra2 = document.getElementById("fila4C2");
		var palabra3_letra3 = document.getElementById("fila5C2");
		var palabra3_letra4 = document.getElementById("fila6C2");
		var palabra3_letra5 = document.getElementById("fila7C2");
		var palabra3_letra6 = document.getElementById("fila8C2");
		var palabra3_letra7 = document.getElementById("fila9C2");
		var palabra3_letra8 = document.getElementById("fila10C2");
		var palabra3_letra9 = document.getElementById("fila11C2");
		var palabra3_letra10 = document.getElementById("fila12C2");
		var palabra3_letra11 = document.getElementById("fila13C2");


		//Palabra BASE DE DATOS
		var palabra4_letra1 = document.getElementById("fila1C10");
		var palabra4_letra2 = document.getElementById("fila2C10");
		var palabra4_letra3 = document.getElementById("fila3C10");
		var palabra4_letra4 = document.getElementById("fila4C10");
		var palabra4_letra5 = document.getElementById("fila6C10");
		var palabra4_letra6 = document.getElementById("fila7C10");
		var palabra4_letra7 = document.getElementById("fila9C10");
		var palabra4_letra8 = document.getElementById("fila10C10");
		var palabra4_letra9 = document.getElementById("fila11C10");
		var palabra4_letra10 = document.getElementById("fila12C10");
		var palabra4_letra11 = document.getElementById("fila13C10");


		//Palabra POST
		var palabra5_letra1 = document.getElementById("fila3C8");
		var palabra5_letra2 = document.getElementById("fila3C9");
		var palabra5_letra3 = document.getElementById("fila3C10");
		var palabra5_letra4 = document.getElementById("fila3C11");

		//Palabra BOTON
		var palabra6_letra1 = document.getElementById("fila6C1");
		var palabra6_letra2 = document.getElementById("fila6C2");
		var palabra6_letra3 = document.getElementById("fila6C3");
		var palabra6_letra4 = document.getElementById("fila6C4");
		var palabra6_letra5 = document.getElementById("fila6C5");
		...
		function verificar() {
			...
			palabra4 = palabra4_letra1.value + palabra4_letra2.value + palabra4_letra3.value + palabra4_letra4.value + palabra4_letra5.value + palabra4_letra6.value + palabra4_letra7.value + palabra4_letra8.value + palabra4_letra9.value + palabra4_letra10.value + palabra4_letra11.value;
			palabra5 = palabra5_letra1.value + palabra5_letra2.value + palabra5_letra3.value + palabra5_letra4.value;
			palabra6 = palabra6_letra1.value + palabra6_letra2.value + palabra6_letra3.value + palabra6_letra4.value + palabra6_letra5.value;
			...
			if (palabra1.toLowerCase() == "formulario" && palabra2.toLowerCase() == "procesar" && palabra3.toLowerCase() == "informacion" && palabra4.toLowerCase() == "basededatos" && palabra5.toLowerCase() == "post" && palabra6.toLowerCase() == "boton") {
				var xmlhttp = new XMLHttpRequest();

				var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 12 + "&id_curso=" + 3; //cancatenation
				...
				if (palabra1.toLowerCase() != "formulario") {
				...
				if (palabra2.toLowerCase() != "procesar") {
				...
				if (palabra3.toLowerCase() != "informacion") {
				...
				if (palabra4.toLowerCase() != "basededatos") {
				...
				if (palabra1.toLowerCase() == "formulario") {
					palabra3_letra10.value = "o";
					palabra2_letra8.value = "r";
					palabra4_letra10.value = "o";
				}

				if (palabra2.toLowerCase() == "procesar") {
					palabra1_letra8.value = "r";
				}
				...
				if (palabra4.toLowerCase() == "basededatos") {
					palabra5_letra3.value = "s";
					palabra1_letra10.value = "o";
				}

				if (palabra5.toLowerCase() == "post") {
					palabra4_letra3.value = "s";
				}
