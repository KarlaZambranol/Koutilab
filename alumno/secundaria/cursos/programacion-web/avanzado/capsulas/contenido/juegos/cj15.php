...
<body onload="iniciarTiempo();">
	...
	<div class="contenido">
		...
		<div class="soup">
			<div id='juego' style="margin: 30px 0 0 90px;"></div>
	...
	<script>
		...
		var words = ['EVENTOS', 'CLIC', 'MOUSEMOVE', 'KEYDOWN', 'JAVASCRIPT', 'CHANGE', 'ERROR', 'DRAGDROP'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 41 + "&id_curso=" + 3; //cancatenation
				Swal.fire({
					title: 'Oops...',
