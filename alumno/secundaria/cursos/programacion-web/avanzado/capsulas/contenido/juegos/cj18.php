...
<body>
	...
	<script>
        ...
        function cargarIconos() {
            iconos = [
				'<i class="fab fa-js-square" style="color: #ffbb00;"></i>',
				'<i class="fas fa-sync-alt fa-spin" style="color: #ff0000;"></i>',
				'<i class="fab fa-php" style="color: #619bff;"></i>',
				'<i class="fas fa-keyboard" style="color: #7c2c87;"></i>',
				'<i class="fab fa-html5" style="color: #ff4d00;"></i>',
				'<i class="fab fa-css3-alt" style="color: #0a64ff;"></i>',
				'<i class="fas fa-bug fa-pulse" style="color: #4dff00; scale: 90%;"></i>',
				'<i class="fas fa-heading"></i>',
				'<i class="fas fa-coffee" style="color: #ffffff;"></i>',
				'<i class="fas fa-shield-alt" style="color: #dedede;"></i>',
				'<i class="fas fa-code" style="color: #5cb800;"></i>',
				'<i class="far fa-file-code" style="color: #00e1ff;"></i>'
            ]
        }
        ...
        function deseleccionar(selecciones) {
            setTimeout(() => {
				...
				if (verificar()) {
					...
					var param = "score=" + 10 + "&validar=" + 'correcto' + "&permiso=" + 9 + "&id_curso=" + 3; //cancatenation
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 9 + "&id_curso=" + 3; //cancatenation
				Swal.fire({
					title: 'Oops...',
