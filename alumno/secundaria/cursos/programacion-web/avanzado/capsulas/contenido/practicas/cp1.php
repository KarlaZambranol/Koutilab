            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Para nuestra primera práctica, vamos a hacer una página que está compuesta de un título,
                                    el cual será una pequeña oración. Posterior a eso, vamos a conseguir un icono de font
                                    awesome que vaya de acuerdo a la oración que realizamos.
                                    <br><br>
                                    La oración puede ser lo que sea,
                                    siempre y cuando se pueda
                                    conseguir un icono adecuado a la oración.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/imports.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
