            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Para la práctica siguiente, vamos a hacer un programa que multiplique los valores de 2
                                    arrays diferentes. Para esto necesitamos iniciar 2 arrays de números de 10
                                    elementos. El resultado final es un array nuevo que en la posición 0
                                    tiene el resultado de multiplicar el primer elemento del array A (A[0])
                                    con el primer elemento del array B (B[0]), En la posición 1 tiene el
                                    resultado de A[1] * B[1], etc...
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/loops.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
