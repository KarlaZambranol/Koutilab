            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Para la práctica final, vamos a hacer una familia de 4 integrantes, cada integrante tendrá los siguientes valores:
                                    <br>
                                    Edad
                                    <br>
                                    Género
                                    <br>
                                    Integrante (mama, papa, hermano menor o mayor, abuelo, primo, tio)
                                    <br>
                                    color favorito
                                    <br><br>
                                    En una página de HTML se deberá mostrar la información de un integrante con un botón.
                                    Cada integrante tendrá su propio botón.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/objects.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
