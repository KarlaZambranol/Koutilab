            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora vamos a hacer una página que tenga 3 elementos,
                                    uno dirá estático, otro dirá amarrado y el último dirá pegajoso.
                                    Cada elemento debe tener el comportamiento de posición de su
                                    nombre, es decir static (estático), fixed (amarrado) y sticky (pegajoso) en ese orden. La página
                                    deberá tener un tamaño largo para poder ver la funcionalidad
                                    de los posicionamientos. Es necesario recordar que debemos usar
                                    un archivo diferente para el CSS.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/position.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
