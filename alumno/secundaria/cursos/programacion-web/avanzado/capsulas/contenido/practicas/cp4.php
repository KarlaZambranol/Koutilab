            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Para la práctica siguiente, vamos a hacer una pagina donde se pueda crear un menú,
                                    Se iniciará un array vacío y con inputs de html se deberá guardar el
                                    nombre de los artículos de un menú, puede ser cualquier comida o bebida.
                                    <br><br>
                                    Debe haber otro input numérico que nos ayude a acceder a la información
                                    del menú, cuando se introduce un número y se presiona un botón, la página
                                    nos devuelve el nombre del menú.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/arrays.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
