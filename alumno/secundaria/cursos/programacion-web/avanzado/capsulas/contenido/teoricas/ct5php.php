        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/ct5php/ct5.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/ct5php/ct55.gif');"></li>
                        <li style="background-image: url('../../img/ct5php/ct555.gif');"></li>
                        <li style="background-image: url('../../img/ct5php/ct5555.gif');"></li>
                        <li style="background-image: url('../../img/ct5php/ct55555.gif');"></li>
                        <li style="background-image: url('../../img/ct5php/ct555555.gif');"></li>
                        <li>
