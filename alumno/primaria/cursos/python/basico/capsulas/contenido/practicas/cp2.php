            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p>Instrucciones: En un párrafo escribe sobre una granja familiar, buscaremos los nombres de personas para ponerlos en
                                    negritas. Los nombres de animales los pondremos en itálicas o cursiva y finalmente las acciones las
                                    pondremos con marcatextos.
                                    <br> <br>
                                    Ejemplos de como debe quedar:<br> <br>
                                    En la granja de <b>Jaime</b> hay 3 jaulas, <b>Rosa</b>, su hija, le <mark>da de comer</mark> a la gallina <i>"TITI"</i>.
                                    <b>Pedro</b> es quien se encarga de <mark>trasquilar</mark> a las ovejas mientras que <b>Laura</b> sale a <mark> darle un paseo</mark> a los caballos <i>"Rosales"</i>.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../vid/CV2.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
        ...
        function miFunc() {
            ...
            if (bolds > 0 && italics > 0 && marks > 0) {
                Swal.fire({
                    ...
                    window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'correcto' + '&permiso=' + 7 + '&id_curso=' + 4 + '&practico=' + 10;
                });
            } else {
                Swal.fire({
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '../../acciones/insertar_pd7.php?validar=' + 'incorrecto' + '&permiso=' + 7 + '&id_curso=' + 4 + '&practico=' + 10;
                    }
                });
            }
        }
