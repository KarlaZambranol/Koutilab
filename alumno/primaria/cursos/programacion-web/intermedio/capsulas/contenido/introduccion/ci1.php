...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Introducción 1 Programacion Web Intermedio</div><br>
            <section id="container-slider">
                ...
                <ul id="slider">
                    ...
                    <li style="background-image: url('../../img/CI2.gif');"></li>
                    ...
                    <li style="background-image: url('../../img/CI3.gif');"></li>
