            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Para la primera práctica, vamos a hacer una página con tres links, un link de texto,
                                    un link como imagen y finalmente un botón que nos redireccione.
                                    La idea es que aprendamos a buscar información por nuestra cuenta,
                                    puedes pedir ayuda de su tutor para encontrar los links que quieres,
                                    sin embargo, en el ejercicio veremos cómo conseguir todo nosotros mismos.
                                    <br><br>
                                    El link en texto debe conducir
                                    a la pagina de aerobot.
                                    <br><br>
                                    La imagen debe ser cualquier
                                    imagen de tu músico o grupo
                                    favorito, debe conducir a un
                                    video de tu canción favorita.
                                    <br><br>
                                    El botón debe decir el nombre
                                    de tu comida favorita y debe
                                    mandarnos a una foto de tu
                                    comida favorita.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/links.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
