            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Vamos a hacer un programa que responda las siguientes preguntas:

                                    Si Javier tiene 50 manzanas y Leo tiene 25, ¿Cuántas manzanas tienen juntos?

                                    Si Javier se come 10 de esas 50 manzanas, ¿Cuántas manzanas le quedan a Javier?
                                    <br><br>
                                    Si Tomas compró 3 cajas de 100 clavos, ¿Cuántos clavos compró en total?
                                    <br><br>
                                    Si Francisco tiene 21 dulces y se los quiere regalar a sus 7 primos, ¿Cuántos dulces le tocan a cada primo?
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/operaciones.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
