            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Vamos a hacer una pagina que nos ayude a aprender a multiplicar.

                                    Tienes que hacer una página que pida 2 números del tamaño que sean y que al
                                    final con un botón que diga "multiplicar" modificará un elemento de texto en
                                    HTML para mostrar el resultado de multiplicar ambos números.
                                    <br><br>


                                    Con esto se consolida el conocimiento de acceder a la información.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/elements.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
