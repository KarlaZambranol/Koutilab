            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Vamos a hacer una función que imprima un saludo el cual recibe el nombre de
                                    la persona que se va a saludar.

                                    El mensaje debe ser: <br><br>

                                    Hola < nombre>, que tengas un bonito día! <br><br>



                                        Debes probar la función con tu nombre.



                                        Deberás hacer otra función que te ayude con las divisiones en la escuela, esta función debe recibir 2 números y finalmente debe imprimir el resultado de dividir el primer numero entre el segundo.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/funciones.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
