            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Tendrás que hacer una función que imprima en consola:
                                    <br>
                                    "tengo < numero> amigos"
                                        <br><br>
                                        < numero> será sustituido por el valor de un numero en javascript. Cada vez que se presione el botón, el número debe aumentar en 5, parecido a como se hizo en el ejercicio.
                                            <br><br>
                                            Hay que recordar que se debe usar el + después de la cadena de texto para unirlo con nuestro valor numérico.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/botones.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
