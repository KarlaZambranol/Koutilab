            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Vamos a escribir tu información e imprimirla en consola en javascript.
                                    ...
                                    - Escuela
                                    <br><br>
                                    Para esto necesitarán hacer 3 variables diferentes y usar console.log(); 3 veces para imprimir la información que guardaron.

                                    Tenemos que iniciar la variable y guardar la información después o puedes hacerlo todo en una sola línea.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/javascript.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
