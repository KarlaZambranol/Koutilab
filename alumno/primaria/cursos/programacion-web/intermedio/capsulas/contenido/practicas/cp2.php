            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Vamos a hacer una pagina donde a la persona que visita nuestro sitio se le pregunte:
                                    <br>
                                    ...
                                    <br><br>
                                    Tendremos que usar los 3 diferentes inputs que vimos y ponerles un id. Es importante recordar usar labels para que la persona sepa qué es lo que le preguntan.
                                    <br><br>
                                    En esta práctica lo más importante es que puedan identificar los inputs necesarios para la pregunta que se hace.

                                    También podrán escribir en el label lo que ellos quieran.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/inputs.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
