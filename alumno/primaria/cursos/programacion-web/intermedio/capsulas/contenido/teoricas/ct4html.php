        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica4html/CT4.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica4html/CT44.gif');"></li>
                        <li style="background-image: url('../../img/teorica4html/CT444.gif');"></li>
                        <li style="background-image: url('../../img/teorica4html/CT4444.gif');"></li>
                        ...
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd11.php">
                                    ...
                                    <h1>¿Cuales son las 2 etiquetas que se usan para crear una tabla?</h1>
