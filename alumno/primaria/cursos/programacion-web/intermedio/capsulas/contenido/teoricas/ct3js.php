...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria3js/CT3.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria3js/CT33.gif');"></li>
                        <li style="background-image: url('../../img/teoria3js/CT333.gif');"></li>
                        <li style="background-image: url('../../img/teoria3js/CT3333.gif');"></li>
                        <li style="background-image: url('../../img/teoria3js/CT33333.gif');"></li>
                        <li style="background-image: url('../../img/teoria3js/CT333333.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd54.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuales son los operadores matematicos basicos?</h1>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == 'Suma, resta, multiplicacion y division' || ta == 'suma, resta, multiplicacion y division' || ta == 'suma resta multiplicacion y division') {
                Swal.fire({
                    title: '¡Bien hecho!',
