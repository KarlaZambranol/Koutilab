...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria2css/CT2.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria2css/CT22.gif');"></li>
                        <li style="background-image: url('../../img/teoria2css/CT222.gif');"></li>
                        <li style="background-image: url('../../img/teoria2css/CT2222.gif');"></li>
                        <li style="background-image: url('../../img/teoria2css/CT22222.gif');"></li>
                        <li style="background-image: url('../../img/teoria2css/CT222222.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd30.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Como puedo agregar fondos multiples?</h1>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == 'background: url("nombre_imagen") right repeat-y, url("nombre_imagen")' || ta == 'background') {
                Swal.fire({
                    title: '¡Bien hecho!',
