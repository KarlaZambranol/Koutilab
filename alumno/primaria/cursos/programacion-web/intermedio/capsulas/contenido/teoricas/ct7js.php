...
if (empty($existe)) {
    header("Location: ../../../../intermedio/capsulas/contenido/pasarela/capsula1.1js.php");
}
...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria7js/CT7.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria7js/CT77.gif');"></li>
                        <li style="background-image: url('../../img/teoria7js/CT777.gif');"></li>
                        <li style="background-image: url('../../img/teoria7js/CT7777.gif');"></li>
                        <li style="background-image: url('../../img/teoria7js/CT77777.gif');"></li>
                        <li style="background-image: url('../../img/teoria7js/CT777777.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd62.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Que podemos agregar para que el usuario de una pagina web introduzca informacion?</h1>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == 'Agregar cuadros de dialogo' || ta == 'agregar cuadros de dialogo' || ta == 'cuadros de dialogo') {
                Swal.fire({
                    title: '¡Bien hecho!',
