...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6 Programación Web Intermedio</div><br>
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/CT6.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/CT66.gif');"></li>
                        <li style="background-image: url('../../img/CT666.gif');"></li>
                        <li style="background-image: url('../../img/CT6666.gif');"></li>
                        <li style="background-image: url('../../img/CT66666.gif');"></li>
                        <li style="background-image: url('../../img/CT66666.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd18.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Qué se escribe en un botón de HTML para usar una funcion de JavaScript?</h1>
