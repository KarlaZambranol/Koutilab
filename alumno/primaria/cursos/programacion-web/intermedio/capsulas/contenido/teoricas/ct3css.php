...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria3css/CT3.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria3css/CT33.gif');"></li>
                        <li style="background-image: url('../../img/teoria3css/CT333.gif');"></li>
                        <li style="background-image: url('../../img/teoria3css/CT3333.gif');"></li>
                        <li style="background-image: url('../../img/teoria3css/CT33333.gif');"></li>
                        <li style="background-image: url('../../img/teoria3css/CT333333.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd33.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cuantas palabras clave existen para referirse a los colores basicos?</h1>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == '17 palabras clave' || ta == '17' || ta == '17 palabras') {
                Swal.fire({
                    title: '¡Bien hecho!',
