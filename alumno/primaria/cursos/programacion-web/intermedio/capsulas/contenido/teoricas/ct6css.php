...
if (empty($existe)) {
    header("Location: ../../../../intermedio/capsulas/contenido/pasarela/capsula1.1css.php");
}
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria6css/CT6.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria6css/CT66.gif');"></li>
                        <li style="background-image: url('../../img/teoria6css/CT666.gif');"></li>
                        <li style="background-image: url('../../img/teoria6css/CT6666.gif');"></li>
                        <li style="background-image: url('../../img/teoria6css/CT66666.gif');"></li>
                        <li style="background-image: url('../../img/teoria6css/CT66666.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd41.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Cualquier item que es lo que debe de tener?</h1>
