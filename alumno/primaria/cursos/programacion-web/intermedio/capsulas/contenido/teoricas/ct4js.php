...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria4js/CT4.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria4js/CT44.gif');"></li>
                        <li style="background-image: url('../../img/teoria4js/CT444.gif');"></li>
                        <li style="background-image: url('../../img/teoria4js/CT4444.gif');"></li>
                        <li style="background-image: url('../../img/teoria4js/CT44444.gif');"></li>
                        <li style="background-image: url('../../img/teoria4js/CT444444.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd56.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Que son los operadores relacionales?</h1>
                                    <input type="hidden" name="permiso" value="11">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="2">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <textarea name="pregunta" onkeyup="actualizar4()" id="pregunta" placeholder="Escriba aquí su respuesta" rows="5" cols="40"></textarea>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == 'Comparan dos valores y ver si uno es mayor, menor o igual que el otro' || ta == 'comparan dos valores y ver si uno es mayor, menor o igual que el otro' || ta == 'Comparan dos valores y ver si uno es mayor menor o igual que el otro') {
                Swal.fire({
                    title: '¡Bien hecho!',
