...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 5 Programación Web Intermedio</div><br>
                        ...
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd15.php">
                                    ...
                                    <h1>En JavaScript Si tengo una funcion que se llama "correr" ¿Qué escribo para usarla?</h1>
