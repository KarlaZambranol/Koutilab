...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria5js/CT5.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria5js/CT55.gif');"></li>
                        <li style="background-image: url('../../img/teoria5js/CT555.gif');"></li>
                        <li style="background-image: url('../../img/teoria5js/CT5555.gif');"></li>
                        <li style="background-image: url('../../img/teoria5js/CT55555.gif');"></li>
                        <li style="background-image: url('../../img/teoria5js/CT555555.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd58.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>La funcion prompt() ¿Para que nos sirve?</h1>
                                    <input type="hidden" name="permiso" value="15">
                                    <input type="hidden" name="teorico" value="10">
                                    <input type="hidden" name="id_curso" value="2">
                                    <input type="hidden" name="validar" id="validar" value="incorrecto">
                                    <textarea name="pregunta" onkeyup="actualizar5()" id="pregunta" placeholder="Escriba aquí su respuesta" rows="5" cols="40"></textarea>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == 'Para obtener informacion del usuario atravez del teclado' || ta == 'para obtener informacion del usuario atravez del teclado') {
                Swal.fire({
                    title: '¡Bien hecho!',
