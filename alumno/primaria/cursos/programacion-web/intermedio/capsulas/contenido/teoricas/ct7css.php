...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria7css/CT7.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria7css/CT77.gif');"></li>
                        <li style="background-image: url('../../img/teoria7css/CT777.gif');"></li>
                        <li style="background-image: url('../../img/teoria7css/CT7777.gif');"></li>
                        <li style="background-image: url('../../img/teoria7css/CT77777.gif');"></li>
                        <li style="background-image: url('../../img/teoria7css/CT777777.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd45.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Que es un contenedor de rejilla?</h1>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == 'Es un elemento padre que contiene elementos colocados en filas y columnas' || ta == 'es un elemento padre que contiene elementos colocados en filas y columnas' || ta == 'es un elemento que tiene elementos colocados en filas y columnas') {
                Swal.fire({
                    title: '¡Bien hecho!',
