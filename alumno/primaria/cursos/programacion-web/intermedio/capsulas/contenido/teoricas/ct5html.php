        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica5html/CT5.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica5html/CT55.gif');"></li>
                        <li style="background-image: url('../../img/teorica5html/CT555.gif');"></li>
                        <li style="background-image: url('../../img/teorica5html/CT5555.gif');"></li>
                        <li style="background-image: url('../../img/teorica5html/CT55555.gif');"></li>
                        <li style="background-image: url('../../img/teorica5html/CT555555.gif');"></li>
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd15.php">
                                    <h2>Para poder avanzar, responde la siguiente pregunta.</h2>
                                    <h1>¿Que atributo indica en que celdas va un encabezado?</h1>
