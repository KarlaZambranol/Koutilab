...
<body>
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teoria4css/CT4.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teoria4css/CT44.gif');"></li>
                        <li style="background-image: url('../../img/teoria4css/CT444.gif');"></li>
                        <li style="background-image: url('../../img/teoria4css/CT4444.gif');"></li>
                        ...
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd36.php">
                                    ...
                                    <h1>¿Cuales son los 2 tipos de nombres de familia de fuente?</h1>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == 'Familia de fuentes y Familia generica' || ta == 'fuentes y generica' || ta == 'generica y fuentes' || ta == 'familia de fuentes y familia generica') {
                Swal.fire({
                    title: '¡Bien hecho!',
