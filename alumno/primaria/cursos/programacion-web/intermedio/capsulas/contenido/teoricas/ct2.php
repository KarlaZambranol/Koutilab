...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 2 Programación Web Intermedio</div><br>
                        ...
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd5.php">
                                    ...
                                    <h1>¿Cómo se llaman en español los recuadros para escribir texto?</h1>
