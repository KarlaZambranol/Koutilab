...
<body>
  <div class="body">
    <div class="container">
      ...
      <div class="new-g" style="text-align: center;">Evaluación 1 Programación Web Intermedio</div><br>
      <div class="quiz-wrapper">
        <hr>
        <p id="inform" class="question-description">Obtenga tantos puntajes como desee en el cuestionario de 6 preguntas. Arrastre y suelte las opciones en el cuadro de arriba.</p>
