...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 5</div><br>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == '<p style="color:blue;">Reloj</p>') {
                Swal.fire({
                    title: '¡Bien hecho!',
