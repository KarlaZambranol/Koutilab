        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica2css/CT2.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica2css/CT22.gif');"></li>
                        <li style="background-image: url('../../img/teorica2css/CT222.gif');"></li>
                        <li style="background-image: url('../../img/teorica2css/CT2222.gif');"></li>
                        <li style="background-image: url('../../img/teorica2css/CT22222.gif');"></li>
                        <li style="background-image: url('../../img/teorica2css/CT222222.gif');"></li>
                        <li>
