        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica3css/CT3.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica3css/CT33.gif');"></li>
                        <li style="background-image: url('../../img/teorica3css/CT333.gif');"></li>
                        <li style="background-image: url('../../img/teorica3css/CT3333.gif');"></li>
                        <li style="background-image: url('../../img/teorica3css/CT33333.gif');"></li>
                        <li style="background-image: url('../../img/teorica3css/CT333333.gif');"></li>
                        <li>
