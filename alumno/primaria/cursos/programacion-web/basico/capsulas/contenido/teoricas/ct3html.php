        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica3html/CT3.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica3html/CT33.gif');"></li>
                        <li style="background-image: url('../../img/teorica3html/CT333.gif');"></li>
                        <li style="background-image: url('../../img/teorica3html/CT3333.gif');"></li>
