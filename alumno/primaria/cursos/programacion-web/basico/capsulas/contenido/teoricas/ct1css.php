        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica1css/CT1.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica1css/CT11.gif');"></li>
                        <li style="background-image: url('../../img/teorica1css/CT111.gif');"></li>
                        <li style="background-image: url('../../img/teorica1css/CT1111.gif');"></li>
