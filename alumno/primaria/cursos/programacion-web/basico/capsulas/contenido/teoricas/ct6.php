...
<body>
    <div class="body">
        <div class="container">
            ...
            <div class="new-g" style="text-align: center;">Cápsula teórica 6</div><br>
                        ...
                        <li>
                            <div style="width:80%; margin-left:10%; ">
                                <form class="forms" id="evaluar" method="POST" enctype="multipart/form-data" action="../../acciones/insertar_pd18.php">
                                    ...
                                    <h1>Escribe el código para poner un fondo de Verde a un div</h1>
    ...
    <script>
        function miFunc() {
            ...
            if (ta == '<div style="background-color:green;">') {
                Swal.fire({
                    title: '¡Bien hecho!',
