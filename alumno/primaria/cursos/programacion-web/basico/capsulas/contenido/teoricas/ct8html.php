        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica8html/CT8.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica8html/CT88.gif');"></li>
                        <li style="background-image: url('../../img/teorica8html/CT888.gif');"></li>
                        <li style="background-image: url('../../img/teorica8html/CT8888.gif');"></li>
