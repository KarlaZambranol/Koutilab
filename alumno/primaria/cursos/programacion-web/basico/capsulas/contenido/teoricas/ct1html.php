...
$consultaIntentos = mysqli_query($conexion, "SELECT intentos FROM detalle_intentos_primaria_primaria WHERE id_capsula = $permiso_intento AND id_alumno = $id_user AND id_curso = 1");
        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica1html/CT1.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica1html/CT11.gif');"></li>
                        <li style="background-image: url('../../img/teorica1html/CT111.gif');"></li>
                        <li style="background-image: url('../../img/teorica1html/CT1111.gif');"></li>
                        <li style="background-image: url('../../img/teorica1html/CT11111.gif');"></li>
                        <li style="background-image: url('../../img/teorica1html/CT111111.gif');"></li>
                        <li>
