        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/teorica6css/CT6.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/teorica6css/CT66.gif');"></li>
                        <li style="background-image: url('../../img/teorica6css/CT666.gif');"></li>
                        <li style="background-image: url('../../img/teorica6css/CT6666.gif');"></li>
                        <li style="background-image: url('../../img/teorica6css/CT66666.gif');"></li>
                        <li style="background-image: url('../../img/teorica6css/CT666666.gif');"></li>
                        <li>
