        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/ct2css/ct2.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/ct2css/ct22.gif');"></li>
                        <li style="background-image: url('../../img/ct2css/ct222.gif');"></li>
                        <li style="background-image: url('../../img/ct2css/ct2222.gif');"></li>
                        <li style="background-image: url('../../img/ct2css/ct22222.gif');"></li>
                        <li style="background-image: url('../../img/ct2css/ct222222.gif');"></li>
                        <li>
