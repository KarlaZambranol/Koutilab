        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/ct1php/ct1.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/ct1php/ct11.gif');"></li>
                        <li style="background-image: url('../../img/ct1php/ct111.gif');"></li>
                        <li style="background-image: url('../../img/ct1php/ct1111.gif');"></li>
                        <li style="background-image: url('../../img/ct1php/ct11111.gif');"></li>
                        <li style="background-image: url('../../img/ct1php/ct111111.gif');"></li>
                        <li>
