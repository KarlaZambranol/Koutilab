        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/ct2js/ct2.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/ct2js/ct22.gif');"></li>
                        <li style="background-image: url('../../img/ct2js/ct222.gif');"></li>
                        <li style="background-image: url('../../img/ct2js/ct2222.gif');"></li>
                        <li style="background-image: url('../../img/ct2js/ct22222.gif');"></li>
                        <li style="background-image: url('../../img/ct2js/ct222222.gif');"></li>
                        <li>
