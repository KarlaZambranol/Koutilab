        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/ct3html/ct3.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/ct3html/ct33.gif');"></li>
                        <li style="background-image: url('../../img/ct3html/ct333.gif');"></li>
                        <li style="background-image: url('../../img/ct3html/ct3333.gif');"></li>
                        <li style="background-image: url('../../img/ct3html/ct33333.gif');"></li>
                        <li style="background-image: url('../../img/ct3html/ct333333.gif');"></li>
                        <li>
