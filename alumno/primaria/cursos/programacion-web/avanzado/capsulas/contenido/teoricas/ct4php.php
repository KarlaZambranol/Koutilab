        ...
        <div class="container">
            ...
            <section id="container-slider">
                <section id="container-slider">
                    ...
                    <ul id="slider">
                        <li style="background-image: url('../../img/ct4php/ct4.gif'); z-index:0; opacity: 1;"></li>
                        <li style="background-image: url('../../img/ct4php/ct44.gif');"></li>
                        <li style="background-image: url('../../img/ct4php/ct444.gif');"></li>
                        <li style="background-image: url('../../img/ct4php/ct4444.gif');"></li>
                        <li style="background-image: url('../../img/ct4php/ct44444.gif');"></li>
                        <li style="background-image: url('../../img/ct4php/ct444444.gif');"></li>
                        <li>
