            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Ahora vamos a hacer un programa que simula un lector de contraseñas.
                                    Se debe tener una variable con un texto que sea la contraseña que debemos
                                    buscar. En una página html debemos tener un input de texto que reciba la
                                    contraseña del usuario. Cuando JS compare ambos strings debe de decirnos
                            ...
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/logic.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
