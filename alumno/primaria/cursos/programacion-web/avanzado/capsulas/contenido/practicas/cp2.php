            ...
            <div class="board">
                <table width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td class="nombre">
                                <p> Vamos a realizar una página web que sea una página de tu presentación.
                                    Debe tener un título con tu nombre, un párrafo que hable sobre
                                    tu comida favorita, un segundo párrafo que hable de tu artista
                                    favorito y finalmente debe tener un párrafo que hable sobre tu escuela.
                                    <br><br>
                                    Estos cuatro elementos deben pertenecer a la clase "aerobot".
                                    <br><br>
                                    En el archivo CSS tendrás que modificar el fondo del HTML con tu color favorito. Después, tienes que
                                    modificar el fondo de todos los elementos de la clase aerobot a un color
                                    negro. Finalmente tienes que modificar el color de las letras de todos los párrafos a blanco.
                                </p>
                            </td>
                            <td class="ne">
                                <video class="js-player" poster="thumbnail.jpg" playsinline controls style="height: 350px; width:100%; border: 1px solid black;">
                                    <source src="../../../../../../vid/selectors.mp4" type="video/mp4" />
                                </video>
                            </td>
                        </tr>
                    </tbody>
