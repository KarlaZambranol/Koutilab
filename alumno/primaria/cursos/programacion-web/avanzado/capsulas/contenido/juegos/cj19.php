...
<body onload="iniciarTiempo();">
	...
	<div class="contenido">
		...
		<div class="soup">
			<div id='juego' style="margin: 50PX 0 0 100px;"></div>
	...
	<script>
		...
		var words = ['PHP', 'INCLUDE', 'REQUIRE', 'FUNCTION', 'ECHO', 'CONDITION', 'HTML', 'CSS'];
	...
	<script>
		...
		function iniciarTiempo() {
			...
			if (segundos == 0) {
				...
				var param = "score=" + 0 + "&validar=" + 'incorrecto' + "&permiso=" + 50 + "&id_curso=" + 3; //cancatenation
				Swal.fire({
					title: 'Oops...',
