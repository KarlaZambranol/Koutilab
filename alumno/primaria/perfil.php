...
<body>
    ...
    <div class="body">
        ...
        <div class="latd">
            ...
            <div class="card">
                <a href="rutas/ruta-ar-b.php">
                    <div class="container">
                        <div class="box">
                            <div class="chart" data-percent="<?php if (isset($data_arduino_basico)) echo $data_arduino_basico['progreso']; ?>" data-scale-color="#ffb400">
                                <?php if (isset($data_arduino_basico)) echo $data_arduino_basico['progreso']; ?>%
                            </div>
            ...
            <div class="card">
                <a href="rutas/ruta-ar-i.php">
                    <div class="container">
                        <div class="box">
                            <div class="chart" data-percent="<?php if (isset($data_arduino_intermedio)) echo $data_arduino_intermedio['progreso']; ?>" data-scale-color="#ffb400">
                                <?php if (isset($data_arduino_intermedio)) echo $data_arduino_intermedio['progreso']; ?>%
                            </div>
            ...
            <div class="card">
                <a href="rutas/ruta-ar-a.php">
                    <div class="container">
                        <div class="box">
                            <div class="chart" data-percent="<?php if (isset($data_arduino_avanzado)) echo $data_arduino_avanzado['progreso']; ?>" data-scale-color="#ffb400">
                                <?php if (isset($data_arduino_avanzado)) echo $data_arduino_avanzado['progreso']; ?>%
                            </div>
